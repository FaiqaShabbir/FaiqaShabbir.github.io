...
app.config['PICTURE_FOLDER'] = 'E:/Final Year Project/HDLPR/picture_uploads'
app.config['VIDEO_FOLDER'] = 'E:/Final Year Project/HDLPR/video_uploads'
...
def generate_challan_image(person_name, father_name, person_cnic, person_contact_number, license_plate_no,
    ...
    hdlpr_text = "HDLPR"
    hdlpr_text_width, hdlpr_text_height = draw.textsize(hdlpr_text, font=font_header)
    ...
    def draw_attribute_box(title, value, x, y):
        ...
        title_width, title_height = draw.textsize(title, font=font_attribute)
        value_width, value_height = draw.textsize(value, font=font_attribute)
